...
#define Q6ROUTING_RX_MIXERS(id)                                               \
	SOC_SINGLE_EXT("MultiMedia1", id, MSM_FRONTEND_DAI_MULTIMEDIA1, 1, 0, \
...
#define Q6ROUTING_TX_MIXERS(id)                                                \
	SOC_SINGLE_EXT("PRI_MI2S_TX", PRIMARY_MI2S_TX, id, 1, 0,               \
		       msm_routing_get_audio_mixer,                            \
		       msm_routing_put_audio_mixer),                           \
		SOC_SINGLE_EXT("SEC_MI2S_TX", SECONDARY_MI2S_TX, id, 1, 0,     \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_MI2S_TX", TERTIARY_MI2S_TX, id, 1, 0,     \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_MI2S_TX", QUATERNARY_MI2S_TX, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_MI2S_TX", QUINARY_MI2S_TX, id, 1, 0,      \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SLIMBUS_0_TX", SLIMBUS_0_TX, id, 1, 0,         \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SLIMBUS_1_TX", SLIMBUS_1_TX, id, 1, 0,         \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SLIMBUS_2_TX", SLIMBUS_2_TX, id, 1, 0,         \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SLIMBUS_3_TX", SLIMBUS_3_TX, id, 1, 0,         \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SLIMBUS_4_TX", SLIMBUS_4_TX, id, 1, 0,         \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SLIMBUS_5_TX", SLIMBUS_5_TX, id, 1, 0,         \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SLIMBUS_6_TX", SLIMBUS_6_TX, id, 1, 0,         \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("PRIMARY_TDM_TX_0", PRIMARY_TDM_TX_0, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("PRIMARY_TDM_TX_1", PRIMARY_TDM_TX_1, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("PRIMARY_TDM_TX_2", PRIMARY_TDM_TX_2, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("PRIMARY_TDM_TX_3", PRIMARY_TDM_TX_3, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("PRIMARY_TDM_TX_4", PRIMARY_TDM_TX_4, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("PRIMARY_TDM_TX_5", PRIMARY_TDM_TX_5, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("PRIMARY_TDM_TX_6", PRIMARY_TDM_TX_6, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("PRIMARY_TDM_TX_7", PRIMARY_TDM_TX_7, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SEC_TDM_TX_0", SECONDARY_TDM_TX_0, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SEC_TDM_TX_1", SECONDARY_TDM_TX_1, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SEC_TDM_TX_2", SECONDARY_TDM_TX_2, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SEC_TDM_TX_3", SECONDARY_TDM_TX_3, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SEC_TDM_TX_4", SECONDARY_TDM_TX_4, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SEC_TDM_TX_5", SECONDARY_TDM_TX_5, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SEC_TDM_TX_6", SECONDARY_TDM_TX_6, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("SEC_TDM_TX_7", SECONDARY_TDM_TX_7, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_TDM_TX_0", TERTIARY_TDM_TX_0, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_TDM_TX_1", TERTIARY_TDM_TX_1, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_TDM_TX_2", TERTIARY_TDM_TX_2, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_TDM_TX_3", TERTIARY_TDM_TX_3, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_TDM_TX_4", TERTIARY_TDM_TX_4, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_TDM_TX_5", TERTIARY_TDM_TX_5, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_TDM_TX_6", TERTIARY_TDM_TX_6, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TERT_TDM_TX_7", TERTIARY_TDM_TX_7, id, 1, 0,   \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_TDM_TX_0", QUATERNARY_TDM_TX_0, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_TDM_TX_1", QUATERNARY_TDM_TX_1, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_TDM_TX_2", QUATERNARY_TDM_TX_2, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_TDM_TX_3", QUATERNARY_TDM_TX_3, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_TDM_TX_4", QUATERNARY_TDM_TX_4, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_TDM_TX_5", QUATERNARY_TDM_TX_5, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_TDM_TX_6", QUATERNARY_TDM_TX_6, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUAT_TDM_TX_7", QUATERNARY_TDM_TX_7, id, 1, 0, \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_TDM_TX_0", QUINARY_TDM_TX_0, id, 1, 0,    \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_TDM_TX_1", QUINARY_TDM_TX_1, id, 1, 0,    \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_TDM_TX_2", QUINARY_TDM_TX_2, id, 1, 0,    \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_TDM_TX_3", QUINARY_TDM_TX_3, id, 1, 0,    \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_TDM_TX_4", QUINARY_TDM_TX_4, id, 1, 0,    \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_TDM_TX_5", QUINARY_TDM_TX_5, id, 1, 0,    \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_TDM_TX_6", QUINARY_TDM_TX_6, id, 1, 0,    \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("QUIN_TDM_TX_7", QUINARY_TDM_TX_7, id, 1, 0,    \
			       msm_routing_get_audio_mixer,                    \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("WSA_CODEC_DMA_TX_0", WSA_CODEC_DMA_TX_0, id,   \
			       1, 0, msm_routing_get_audio_mixer,              \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("WSA_CODEC_DMA_TX_1", WSA_CODEC_DMA_TX_1, id,   \
			       1, 0, msm_routing_get_audio_mixer,              \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("WSA_CODEC_DMA_TX_2", WSA_CODEC_DMA_TX_2, id,   \
			       1, 0, msm_routing_get_audio_mixer,              \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("VA_CODEC_DMA_TX_0", VA_CODEC_DMA_TX_0, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("VA_CODEC_DMA_TX_1", VA_CODEC_DMA_TX_1, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("VA_CODEC_DMA_TX_2", VA_CODEC_DMA_TX_2, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TX_CODEC_DMA_TX_0", TX_CODEC_DMA_TX_0, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TX_CODEC_DMA_TX_1", TX_CODEC_DMA_TX_1, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TX_CODEC_DMA_TX_2", TX_CODEC_DMA_TX_2, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TX_CODEC_DMA_TX_3", TX_CODEC_DMA_TX_3, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TX_CODEC_DMA_TX_4", TX_CODEC_DMA_TX_4, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),                   \
		SOC_SINGLE_EXT("TX_CODEC_DMA_TX_5", TX_CODEC_DMA_TX_5, id, 1,  \
			       0, msm_routing_get_audio_mixer,                 \
			       msm_routing_put_audio_mixer),
 ...
 */
int q6routing_stream_open(int fedai_id, int perf_mode, int stream_id,
			  int stream_type)
{
	...
	if (session->port_id < 0) {
		dev_err(routing_data->dev,
			"Routing not setup for MultiMedia%d Session\n",
			session->fedai_id);
		return -EINVAL;
	}
	...
	if (num_copps) {
		...
		q6adm_matrix_map(routing_data->dev, session->path_type, payload,
				 perf_mode);
	}
	mutex_unlock(&routing_data->lock);
...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	SND_SOC_DAPM_MIXER("MultiMedia1 Mixer", SND_SOC_NOPM, 0, 0,
			   mmul1_mixer_controls,
			   ARRAY_SIZE(mmul1_mixer_controls)),
	SND_SOC_DAPM_MIXER("MultiMedia2 Mixer", SND_SOC_NOPM, 0, 0,
			   mmul2_mixer_controls,
			   ARRAY_SIZE(mmul2_mixer_controls)),
	SND_SOC_DAPM_MIXER("MultiMedia3 Mixer", SND_SOC_NOPM, 0, 0,
			   mmul3_mixer_controls,
			   ARRAY_SIZE(mmul3_mixer_controls)),
	SND_SOC_DAPM_MIXER("MultiMedia4 Mixer", SND_SOC_NOPM, 0, 0,
			   mmul4_mixer_controls,
			   ARRAY_SIZE(mmul4_mixer_controls)),
	SND_SOC_DAPM_MIXER("MultiMedia5 Mixer", SND_SOC_NOPM, 0, 0,
			   mmul5_mixer_controls,
			   ARRAY_SIZE(mmul5_mixer_controls)),
	SND_SOC_DAPM_MIXER("MultiMedia6 Mixer", SND_SOC_NOPM, 0, 0,
			   mmul6_mixer_controls,
			   ARRAY_SIZE(mmul6_mixer_controls)),
	SND_SOC_DAPM_MIXER("MultiMedia7 Mixer", SND_SOC_NOPM, 0, 0,
			   mmul7_mixer_controls,
			   ARRAY_SIZE(mmul7_mixer_controls)),
	SND_SOC_DAPM_MIXER("MultiMedia8 Mixer", SND_SOC_NOPM, 0, 0,
			   mmul8_mixer_controls,
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	Q6ROUTING_RX_DAPM_ROUTE("WSA_CODEC_DMA_RX_0 Audio Mixer",
				"WSA_CODEC_DMA_RX_0"),
	Q6ROUTING_RX_DAPM_ROUTE("WSA_CODEC_DMA_RX_1 Audio Mixer",
				"WSA_CODEC_DMA_RX_1"),
	Q6ROUTING_RX_DAPM_ROUTE("RX_CODEC_DMA_RX_0 Audio Mixer",
				"RX_CODEC_DMA_RX_0"),
	Q6ROUTING_RX_DAPM_ROUTE("RX_CODEC_DMA_RX_1 Audio Mixer",
				"RX_CODEC_DMA_RX_1"),
	Q6ROUTING_RX_DAPM_ROUTE("RX_CODEC_DMA_RX_2 Audio Mixer",
				"RX_CODEC_DMA_RX_2"),
	Q6ROUTING_RX_DAPM_ROUTE("RX_CODEC_DMA_RX_3 Audio Mixer",
				"RX_CODEC_DMA_RX_3"),
	Q6ROUTING_RX_DAPM_ROUTE("RX_CODEC_DMA_RX_4 Audio Mixer",
				"RX_CODEC_DMA_RX_4"),
	Q6ROUTING_RX_DAPM_ROUTE("RX_CODEC_DMA_RX_5 Audio Mixer",
				"RX_CODEC_DMA_RX_5"),
	Q6ROUTING_RX_DAPM_ROUTE("RX_CODEC_DMA_RX_6 Audio Mixer",
				"RX_CODEC_DMA_RX_6"),
	Q6ROUTING_RX_DAPM_ROUTE("RX_CODEC_DMA_RX_7 Audio Mixer",
				"RX_CODEC_DMA_RX_7"),
